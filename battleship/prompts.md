...
* Let's start the game. Once the ready button is pressed, instead of an alert we will go to play mode. Per turns, the human and AI will choose a position where they think there is a ship. If a ship is hit, we show red, if water
